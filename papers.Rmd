...
dat0 <- cv |> 
  ...
  # publications
  content = ifelse((section == "publications" & description_1 != "N/A"), 
                                 paste0(content, description_1), 
                                 content),
  content = ifelse((section == "publications" & Links != ""), 
                                 paste0(content, " ", Links, ". "), 
                                 content),  
  # presentations
  content = ifelse((section == "presentations" & !(is.na(description_bullets))),  
                                 paste0(content, "\n\n", description_bullets), 
                                 content),
  content = ifelse((section == "presentations" & Links_inline != ""), 
                                 paste0(content, "\n\n - ", Links_inline), 
                                 content),
  
  # Social
    content0 = paste0(ifelse(loc == "N/A", "", paste0(loc, ". ")),"**",
                                   title, ".** ", loc1, ". "),
  content = ifelse((section == "social" & Links != ""), 
                                 paste0(content0, " ", Links, ". "), 
                                 content), 
  # clean up 
...
for (i in c("Publications", "Presentations", "Webstories and Social Media")){
