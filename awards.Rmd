...
# dat$content <- temp
dat$img <- c("images/AMS.jpg", 
             "images/panel.jpg")
dat$img_txt <- c("American Meteorological Society Early Career Leadership Academy in-person summit in Stone Mountain, GA, 2019.", 
                 "The Stony Brook University Earthstock sustainability alumni panel.")
