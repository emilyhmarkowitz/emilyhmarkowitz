...
dat$img <- c("images/wise.jpg",
             "images/expertisin.jpg", 
             "images/outreach.jpg")
dat$img_txt <- c("Stony Brook WISE (Women in Science and Engineering) working up some of the day’s data from our mini-study on blue crab temperature-dependent aerobic and anaerobic metabolism.", 
